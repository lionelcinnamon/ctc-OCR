...
class BaseModel(object):
    ...
    def __init__(self, config):
        ...
        """
        self.config = config
        self.logger = get_logger(self.config.get_path('log_path', 'C'))
    ...
    def restore_session(self):
        ...
        dir_model = self.config.get_path('model_path', 'M')
    ...
    def train(self, config, train_set, val_set, lr_schedule):
        ...
        for epoch in range(config.n_epochs):
            ...
            if best_score is None or score >= best_score:
                ...
                self.save_session(config.get_file_path(config.dir_output, config.model_output_name))
